...
public class BattleShipTests
{
    ...
    [Fact]
    public void
        Si_ElPrimerJugadorDisparaAl_0_9_YAciertaAUnBarcoCañonero_Debe_MarcarUna_X_EnElTablero()
    {
        _battleship.AddPlayer(_defaultFleetWithValidPositions);
        _battleship.AddPlayer(_fleetWithShipsInTheLastColumns);
        _battleship.Start();
    ...
    [Fact]
    public void
        Si_ElPrimerJugadorDisparaAl_0_7_YAciertaAUnBarcoPortaaviones_Debe_MarcarUna_x_EnElTablero()
    {
        _battleship.AddPlayer(_defaultFleetWithValidPositions);
        _battleship.AddPlayer(new Fleet([
            Gunboat.Create(new Coord(6,9)),
        ...
        _battleship.Start();
        _battleship.Fire(new Coord(0,7));
    ...
    [Fact]
    public void
        Si_ElPrimerJugadorDisparaAl_06_07_08_Y_09_YAciertaAUnBarcoPortaaviones_Debe_MarcarUna_X_EnLasPosiciones()
    {
        _battleship.AddPlayer(_defaultFleetWithValidPositions);
        _battleship.AddPlayer(new Fleet([
            Gunboat.Create(new Coord(6,9)),
        ...
        _battleship.Start();
        _battleship.Fire(new Coord(0,6));
        _battleship.Fire(new Coord(0,7));
        _battleship.Fire(new Coord(0,8));
        _battleship.Fire(new Coord(0,9));
    ...
    [Fact]
    public void
        Si_ElPrimerJugadorDisparaAl_06_07_08_Y_09_YAciertaAUnBarcoPortaaviones_Debe_ElMensajeDelTiroSerBarcoHundido()
    {
        _battleship.AddPlayer(_defaultFleetWithValidPositions);
        _battleship.AddPlayer(new Fleet([
            Gunboat.Create(new Coord(6,9)),
    ...
    [Fact]
    public void
        Si_ElPrimerJugadorDisparaAl_1_7_Y_1_8_YAciertaAUnBarcoDestructor_Debe_MarcarUna_x_EnLasPosiciones()
    {
        _battleship.AddPlayer(_defaultFleetWithValidPositions);
        _battleship.AddPlayer(new Fleet([
            Gunboat.Create(new Coord(6,9)),
    ...
    [Fact]
    public void
        Si_ElPrimerJugadorDisparaAl_1_7__1_8_Y_1_9_YAciertaAUnBarcoDestructor_Debe_MarcarUna_X_EnLasPosiciones()
    {
        _battleship.AddPlayer(_defaultFleetWithValidPositions);
        _battleship.AddPlayer(new Fleet([
            Gunboat.Create(new Coord(6,9)),
