...
public class AcorazadosTestBK
{
    ...
    {
        var juegoAcorazado = () => new JuegoAcorazadoBK(0, 0);
    ...
    {
        var juegoAcorazado = () => new JuegoAcorazadoBK(10, 10);
    ...
    {
        var juegoAcorazado = () => new JuegoAcorazadoBK(-1, -1);
    ...
    {
        var juegoAcorazado = new JuegoAcorazadoBK(tamañoX, tamañoY);
...
public class JuegoAcorazadoBK
{
    ...
    public JuegoAcorazadoBK(int tamañoEnX, int tamañoEnY)
    {
